  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex flex-wrap items-end justify-between gap-4 mb-5">
        ...
        <a href="/admin/products/new" className="flex items-center gap-1.5 bg-accent text-navy font-semibold text-sm px-4 py-2.5 rounded-lg hover:bg-brick hover:text-white transition">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-5">
        <select
          ...
          className="rounded-lg border border-stone px-3 py-2 text-sm bg-white focus:outline-none focus:border-navy"
        >

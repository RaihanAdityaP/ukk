...
export default function AdminOrdersPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-8">
      ...
      {loading ? (
        <div className="bg-white rounded-2xl border border-stone/50 overflow-hidden shadow-sm p-6 space-y-4">
          <div className="flex items-center justify-center gap-2 py-6 text-navy">

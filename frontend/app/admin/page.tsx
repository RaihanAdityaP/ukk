  ...
  if (loading) {
    return (
      <main className="max-w-6xl mx-auto px-4 py-8 animate-pulse">
        ...
        <div className="flex items-center justify-center gap-2 py-3 mb-6 text-navy">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-white rounded-2xl p-6 border border-stone/40 space-y-4">
            <div className="h-6 w-48 bg-stone/40 rounded" />
            <div className="space-y-3">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="h-14 w-full bg-stone/20 rounded-xl" />
              ))}
            </div>
          </div>

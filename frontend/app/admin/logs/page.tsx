...
import { ArrowLeft, Clock, RefreshCw, Shield, User, Activity, Package, ShoppingBag, LogIn, Loader2 } from 'lucide-react'
    ...
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      {loading ? (
        <div className="space-y-3">
          ...
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="flex items-center gap-3 bg-white rounded-xl p-3.5 border border-stone/30 animate-pulse">
              <div className="w-8 h-8 rounded-lg bg-stone/30 shrink-0" />
              <div className="flex-1 space-y-2">
                <div className="h-4 w-3/4 bg-stone/40 rounded" />
                <div className="h-3 w-1/3 bg-stone/20 rounded" />
              </div>
